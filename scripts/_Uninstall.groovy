...
//
// check to see if we already have a PrettifyGriffonAddon
// def configText = '''root.'PrettifyGriffonAddon'.addon=true'''
// if(builderConfigFile.text.contains(configText)) {
//     println 'Removing PrettifyGriffonAddon from Builder.groovy'
